...
return {
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			-- mmaper>gf", function() Snacks.picker.git_log_file() end, { desc = "Git Current File History" })
			-- Slightly advanced example of overriding default behavior and theme
			map("n", "<leader>gs", builtin.git_status, { desc = "[G]it [S]tatus" })
			map("n", "<leader>gt", builtin.git_branches, { desc = "[G]it branches" })
			-- map('n', '<leader>gl', , { desc = '[S]earch [F]iles' })
